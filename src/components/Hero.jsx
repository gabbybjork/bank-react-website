...
const Hero = () => (
  <section id="home" className={`flex md:flex-row felx-col ${styles.paddingY}`}>
  ...
  flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}> Our team of experts used a methodology to identify the credit cards most likely to fit your needs. We examine annual percentage rates, annual fees.</p>
